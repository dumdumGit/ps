      ...
      <div class="box box-info">
        <div class="box-header">
          <section class="content-header">
            <h1>
              Mengedit Riset<br>
              <small>Disini anda dapat mengedit Postingan Riset</small>
            </h1>
          </section>
        </div>
        <!-- /.box-header -->
        <div class="box-body pad">
          <form method="post" action="/riset/{{$riset->id}}">
            {{ csrf_field() }}
            <input value="{{$riset->judul}}" class="form-control" style="width:100%" type="text" name="judul" placeholder="Judul">
            <br>
